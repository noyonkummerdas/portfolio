        ...
        <div className="group relative bg-secondary/40 backdrop-blur-xl border border-white/5 rounded-3xl overflow-hidden transition-all duration-700 hover:-translate-y-3 hover:shadow-[0_40px_80px_rgba(99,102,241,0.15)]">
            ...
            <div className="p-6 md:p-10 relative z-10">
                ...
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl md:text-2xl font-bold font-poppins text-white group-hover:text-indigo-400 transition-colors duration-500">
                        {project.name}
                    </h3>
                ...
                {/* Tagline */}
                <p className="text-lg md:text-xl text-gray-200 font-medium mb-8 leading-relaxed font-poppins">
                    {project.tagline}
                </p>
                ...
                <div className="space-y-6 mb-10">
                    <div>
                        ...
                        <p className="text-xs md:text-sm text-gray-400 leading-relaxed font-inter line-clamp-2">{project.problem}</p>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-2">
                            {project.features.slice(0, 2).map((feature, idx) => (
                                <li key={idx} className="text-xs md:text-sm text-gray-300 flex items-start gap-3 font-inter">
                ...
                <Link
                    ...
                    className="relative block w-full py-4 text-center overflow-hidden group/btn bg-white text-black font-black rounded-2xl transition-all duration-300 hover:bg-indigo-600 hover:text-white transform active:scale-95 shadow-2xl font-poppins text-[10px] md:text-xs uppercase tracking-widest"
                >
