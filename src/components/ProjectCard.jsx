...
const ProjectCard = ({ project }) => {
    return (
        <div className="group relative bg-[#1A1A1A]/40 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden transition-all duration-700 hover:-translate-y-3 hover:shadow-[0_40px_80px_rgba(99,102,241,0.2)]">
