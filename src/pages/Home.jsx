        ...
        <div className="pt-20">
            ...
            <section className="relative pt-24 pb-32 px-6 overflow-hidden">
                <div className="relative z-10 max-w-7xl mx-auto text-center">
                    ...
                    <h1 className="text-6xl md:text-8xl lg:text-9xl font-black font-poppins mb-8 tracking-tighter leading-[0.9] text-slate-900 dark:text-white">
                        Crafting <br />
                        <span className="text-primary drop-shadow-[0_0_15px_rgba(56,189,248,0.3)]">Premium Digital</span><br />
                        Experiences
                    </h1>
                    <p className="text-xl md:text-2xl text-slate-600 dark:text-textMain/60 max-w-3xl mx-auto leading-relaxed font-inter mb-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
                        ...
                        <Link to="/cv" className="px-10 py-5 bg-slate-200 dark:bg-white/5 hover:bg-slate-300 dark:hover:bg-white/10 text-slate-900 dark:text-white font-bold rounded-2xl border border-slate-300 dark:border-white/10 backdrop-blur-md transition-all duration-300">
                            CV
            ...
            {/* Why Hire Me Section */}
            <section className="py-24 px-6 bg-slate-100 dark:bg-surface/30 border-y border-slate-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-6xl font-black font-poppins text-slate-900 dark:text-white mb-4 tracking-tighter">
                            Why Hire Me<span className="text-primary">.</span>
                        </h2>
                        <p className="text-slate-600 dark:text-textMain/50 max-w-2xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="p-8 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-surface/50 hover:border-primary/30 transition-colors shadow-sm dark:shadow-none">
                                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
                                    <div className="w-2 h-2 rounded-full bg-primary" />
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">{item.title}</h3>
                                <p className="text-slate-600 dark:text-textMain/60 text-sm leading-relaxed">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-20">
                    <div>
                        ...
                        <p className="text-slate-600 dark:text-textMain/50 max-w-md font-inter">
                            High-stakes projects delivering real business value through React & React Native excellence.
                        </p>
                    </div>
                    <Link to="/projects" className="text-sm font-bold text-primary hover:text-slate-900 dark:hover:text-white transition-colors uppercase tracking-widest flex items-center gap-2 group">
            ...
            {/* Expertise Section */}
            <section className="py-24 px-6 bg-slate-50 dark:bg-surface/20 border-t border-slate-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <h2 className="text-4xl md:text-6xl font-black font-poppins text-slate-900 dark:text-white mb-8 tracking-tighter">
                                Core Skills &<br />
                            ...
                            <div className="flex flex-wrap gap-4">
                                {["React", "React Native", "TypeScript", "Node.js", "Tailwind CSS", "Redux", "Firebase", "AWS"].map((skill, idx) => (
                                    <span key={idx} className="px-6 py-3 bg-slate-200 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-xl text-slate-700 dark:text-textMain/80 font-bold text-sm">
                                        {skill}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-8 rounded-2xl bg-white dark:bg-surface/50 border border-slate-200 dark:border-white/5 text-center shadow-sm dark:shadow-none">
