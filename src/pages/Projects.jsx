    ...
    return (
        <div className="pt-32 min-h-screen">
            <section className="px-6 max-w-7xl mx-auto mb-20 text-center md:text-left">
                ...
                <p className="text-lg sm:text-xl text-slate-600 dark:text-textMain/50 max-w-2xl mb-10 md:mb-12 mx-auto md:mx-0">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 md:gap-3 mb-12 md:mb-16">
                    {techs.map((tech) => (
                        <button
                            ...
                            className={`px-4 py-2 sm:px-6 sm:py-2 rounded-full border text-xs font-black uppercase tracking-widest transition-all duration-300 transform active:scale-95 ${filter === tech
                                ? 'bg-primary border-primary text-secondary shadow-lg shadow-primary/20'
                                : 'bg-slate-200 dark:bg-white/5 border-slate-300 dark:border-white/10 text-slate-700 dark:text-textMain/40 hover:border-primary/50'
                                }`}
                        >
                            {tech}
                        </button>
