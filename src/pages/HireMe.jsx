    ...
    return (
        <div className="pt-32 min-h-screen pb-20">
            ...
            <section className="px-6 max-w-4xl mx-auto text-center mb-16 md:mb-20">
                <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-400 text-xs font-black uppercase tracking-[0.3em] animate-fade-in">
                    Open for Business
                </div>
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 md:mb-8 tracking-tighter text-slate-900 dark:text-white leading-[1.1]">
                ...
                <p className="text-base sm:text-xl text-slate-600 dark:text-gray-400 mb-10 leading-relaxed max-w-2xl mx-auto">
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 mb-24">
                ...
                <div className="order-2 lg:order-1">
                    <h2 className="text-2xl md:text-3xl font-black mb-8 text-slate-900 dark:text-white text-center lg:text-left">How I Add Value</h2>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 sm:p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] order-1 lg:order-2 self-start">
                    <h2 className="text-xl md:text-2xl font-black mb-6 text-slate-900 dark:text-white text-center lg:text-left">Tell me about your project</h2>
                    <form onSubmit={handleSubmit} className="space-y-6">

                        {/* Client Info */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest font-bold text-slate-700 dark:text-gray-400">Name</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest font-bold text-slate-700 dark:text-gray-400">Email</label>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest font-bold text-slate-700 dark:text-gray-400">
                                    Project Type
                                </label>
                 ...
                 appearance-none cursor-pointer text-sm pr-10"
                            ...
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest font-bold text-slate-700 dark:text-gray-400">Target Timeline</label>
                        ...
                        {/* Budget */}
                        <div className="space-y-2">
                            <label className="text-xs uppercase tracking-widest font-bold text-gray-400">Estimated Budget</label>
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                {['<$5k', '$5k-$10k', '$10k-$20k', '$20k+'].map(b => (
                                    <button
                                        ...
                                        className={`px-2 py-2.5 rounded-lg text-xs font-bold border transition-all ${formData.budget === b ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-white/5 border-white/10 text-gray-400 hover:bg-white/10'}`}
                                    >
                                        {b}
                                    </button>
                                ))}
                        ...
                        {/* Details */}
                        <div className="space-y-2">
                            <label className="text-xs uppercase tracking-widest font-bold text-slate-700 dark:text-gray-400">Project Goals & Requirements</label>
                            <textarea
                                name="details"
